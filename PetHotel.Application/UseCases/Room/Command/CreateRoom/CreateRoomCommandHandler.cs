...
public class CreateRoomCommandHandler(ILogger<CreateRoomCommandHandler> logger, IMapper mapper, IRoomRepository roomRepository, IHotelRepository hotelRepository) :
